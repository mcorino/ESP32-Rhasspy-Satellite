...
struct Config {
  ...
  uint16_t hotword_detection = HW_LOCAL;
...
std::string startListeningTopic = "hermes/asr/startListening";
std::string stopListeningTopic = "hermes/asr/stopListening";
std::string asrToggleOffTopic = "hermes/asr/toggleOff";
...
struct HotwordOnEvent : tinyfsm::Event { };
struct HotwordOffEvent : tinyfsm::Event { };
